...
This repository is set up for **agent-first, staged delivery** with an MVP-first roadmap and traceable execution.

## Documentation Structure

- Project docs: [`docs/project/`](docs/project/)
  - Stages & increments: [`docs/project/stages-and-increments.md`](docs/project/stages-and-increments.md)
